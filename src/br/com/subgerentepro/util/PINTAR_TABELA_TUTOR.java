 ...
 * @author X552E
 */
public class PINTAR_TABELA_TUTOR extends DefaultTableCellRenderer {
//*************************************************************************
...
//criamos o construtor 
    ...
    public Component getTableCellRendererComponent(JTable table, Object value, boolean isSelected, boolean hasFocus, int row, int column) {
        ...
        try {
            ...
            String tutor =objeto.toString();
            //PINTANDO SETORES INTERNOS DO PROTOCOLO 
            if(tutor.equalsIgnoreCase("TITULAR")){
                background=Color.BLACK;
                foregroud=Color.WHITE;
            }else{
                background= new Color(0,103,139);
                foregroud=Color.WHITE;
