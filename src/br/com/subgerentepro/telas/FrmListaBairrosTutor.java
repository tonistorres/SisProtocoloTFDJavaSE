...
import static br.com.subgerentepro.telas.TelaTutorTFD.txtBairroTutor;
import static br.com.subgerentepro.telas.TelaTutorTFD.txtIdBairroTutor;
 ...
 * @author DaTorres
 */
public class FrmListaBairrosTutor extends javax.swing.JInternalFrame {
     ...
     */
    private static FrmListaBairrosTutor instance = null;

    public static FrmListaBairrosTutor getInstance() {

        if (instance == null) {

            instance = new FrmListaBairrosTutor();
    ...
    public FrmListaBairrosTutor() {
        initComponents();
       
        txtFiltroIDCidade.setText(txtidCidadeTutor.getText());
    ...
    private void initComponents() {
        ...
        painelCabecalho.add(txtFiltroIDCidade, new org.netbeans.lib.awtextra.AbsoluteConstraints(260, 50, 32, 32));
        ...
        painelCabecalho.add(btnPesquisar, new org.netbeans.lib.awtextra.AbsoluteConstraints(210, 50, 32, 32));

        lblIDCidadeFiltro.setText("FiltroID");
        painelCabecalho.add(lblIDCidadeFiltro, new org.netbeans.lib.awtextra.AbsoluteConstraints(260, 30, -1, -1));
        ...
        painelCabecalho.add(btnCadastrarBairros, new org.netbeans.lib.awtextra.AbsoluteConstraints(310, 50, 32, 32));

        jLabel1.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        jLabel1.setText("Bairros");
        painelCabecalho.add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(300, 30, 50, -1));
        ...
        painelCabecalho.add(jButton1, new org.netbeans.lib.awtextra.AbsoluteConstraints(350, 50, 32, 32));

        jLabel2.setText("Atualizar");
        painelCabecalho.add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(350, 30, -1, -1));
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    .addComponent(painelCabecalho, javax.swing.GroupLayout.DEFAULT_SIZE, 419, Short.MAX_VALUE)
    ...
    private void tabelaMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tabelaMouseClicked
        ...
        txtIdBairroTutor.setText(tabela.getValueAt(linha, 0).toString());
        txtBairroTutor.setText(tabela.getValueAt(linha, 1).toString());
