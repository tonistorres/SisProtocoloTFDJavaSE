 ...
 * @author Dã Torres
 */
public class FluxoSistemaGenericoTFD extends javax.swing.JInternalFrame {
    ...
    public FluxoSistemaGenericoTFD() {
        initComponents();
        aoCarregarForm();
        //*********************************************************************
    ...
    public void addRowJTable() {
        ...
        String filtrarPorIdCustomizado = lblDadosProtocoloRepositIDCustomizado.getText();
    ...
    private void frontEnd() {
        ...
        painelDadosFluxo.setBackground(new Color(9, 81, 107));
...
//        
    ...
    private void initComponents() {
        ...
        painelPrincipal.add(painelInfoPaciente, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 70, 340, 90));
        ...
        painelPrincipal.add(painelDadosUsuarioMaquina, new org.netbeans.lib.awtextra.AbsoluteConstraints(350, 60, 400, 100));
        ...
        painelPrincipal.add(lblLinhaInformativa, new org.netbeans.lib.awtextra.AbsoluteConstraints(350, 0, 410, 50));

        lblNuvemBackEnd.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagens/barra/nuvem/nuvemConectada.png"))); // NOI18N
        painelPrincipal.add(lblNuvemBackEnd, new org.netbeans.lib.awtextra.AbsoluteConstraints(230, 20, 60, 40));
        painelPrincipal.add(barProgressProcedimentosBackEnd, new org.netbeans.lib.awtextra.AbsoluteConstraints(290, 40, 50, -1));

        lblInfoProcessosBackEnd.setFont(new java.awt.Font("Tahoma", 1, 9)); // NOI18N
        lblInfoProcessosBackEnd.setText("Back-End");
        painelPrincipal.add(lblInfoProcessosBackEnd, new org.netbeans.lib.awtextra.AbsoluteConstraints(290, 20, 50, 20));
        ...
        painelPrincipal.add(btnSalvar, new org.netbeans.lib.awtextra.AbsoluteConstraints(700, 260, 45, 45));
        ...
        painelPrincipal.add(lblConsultarProtocolo, new org.netbeans.lib.awtextra.AbsoluteConstraints(100, 0, 40, 30));
        ...
        painelPrincipal.add(txtIdCustomBuscar, new org.netbeans.lib.awtextra.AbsoluteConstraints(12, 32, 170, 30));
        ...
        painelPrincipal.add(btnBuscarIdCustom, new org.netbeans.lib.awtextra.AbsoluteConstraints(190, 30, 32, 32));

        painelDadosFluxo.setBackground(new java.awt.Color(51, 51, 255));
        painelDadosFluxo.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Dados Fluxo:", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 0, 11), java.awt.Color.white)); // NOI18N
        ...
        painelDadosFluxo.add(lblNProtocolo, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 20, -1, -1));
        ...
        painelDadosFluxo.add(lblDataProtocolada, new org.netbeans.lib.awtextra.AbsoluteConstraints(130, 20, -1, -1));
        ...
        painelDadosFluxo.add(lblDepOrigem, new org.netbeans.lib.awtextra.AbsoluteConstraints(420, 20, -1, -1));
        ...
        painelDadosFluxo.add(lblInteressadoDepOrigem, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 50, -1, -1));
        ...
        painelDadosFluxo.add(lblDtTransf, new org.netbeans.lib.awtextra.AbsoluteConstraints(270, 20, -1, -1));
        ...
        painelDadosFluxo.add(lblSetorInterno, new org.netbeans.lib.awtextra.AbsoluteConstraints(320, 50, 50, -1));
        ...
        painelPrincipal.add(painelDadosFluxo, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 160, 740, 80));
        ...
        painelPrincipal.add(cboMascaraCustomizada, new org.netbeans.lib.awtextra.AbsoluteConstraints(140, 0, 40, 30));
        ...
        painelPrincipal.add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 310, 740, 140));
        ...
        painelPrincipal.add(cbDepVinculadosFluxoTFD, new org.netbeans.lib.awtextra.AbsoluteConstraints(210, 270, 230, 28));
        ...
        painelPrincipal.add(cbInteressado, new org.netbeans.lib.awtextra.AbsoluteConstraints(450, 270, 230, 30));

        lblAosCuidados.setFont(new java.awt.Font("Tahoma", 1, 11)); // NOI18N
        lblAosCuidados.setText("Aos Cuidados:");
        painelPrincipal.add(lblAosCuidados, new org.netbeans.lib.awtextra.AbsoluteConstraints(450, 250, 100, -1));

        getContentPane().add(painelPrincipal, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 760, 460));
    ...
    private void cbFluxoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cbFluxoActionPerformed
        ...
        if (lblRepoPerfil.getText().equalsIgnoreCase("CONTABILIDADE") && itemSelecionado.equalsIgnoreCase("RECEBIDO|ENCAMINHANDO")) {
            ...
            if (recebeConexao == true) {
                ...
                try {
                    ...
                    for (int i = 0; i < list.size(); i++) {
                        ...
                        if (list.get(i).getNomeDto().equalsIgnoreCase("TESOURARIA")) {
        ...
        if (lblRepoPerfil.getText().equalsIgnoreCase("CONTABILIDADE") && itemSelecionado.equalsIgnoreCase("DEVOLVENDO CORRECAO")) {
            ...
            if (recebeConexao == true) {
                ...
                try {
                    ...
                    for (int i = 0; i < list.size(); i++) {
                        ...
                        // e já setando automaticamente o fluxo para quenão ocorra erro 
                        //por parte do usuário 
                        if (list.get(i).getNomeDto().equalsIgnoreCase("PROTOCOLO")) {
                            cbDepVinculadosFluxoTFD.addItem(list.get(i).getNomeDto());
                        }
                    }
    ...
    private void enviarEmailFluxoContabilidadeTesouraria() {
     ...
     //   String emailProcuradorGeral = "affonsobbatista@hotmail.com";//email para contabilidade TEM SISTEMA PARA CONSULTAR
        ...
        try {
            ...
            //email.addTo(emailDestinatario);// prefeitura de alto alegre ADRIANO
