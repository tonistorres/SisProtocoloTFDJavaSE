...
import static br.com.subgerentepro.telas.TelaTutorTFD.txtEstadoTutor;
 ...
 * @author DaTorres
 */
public class FrmListaEstadosTutor extends javax.swing.JInternalFrame {
     ...
     */
    private static FrmListaEstadosTutor instance = null;

    public static FrmListaEstadosTutor getInstance() {

        if (instance == null) {

            instance = new FrmListaEstadosTutor();
    ...
    private void setarEstado(){
        ...
        if (recebeConexao == true) {
            ...
            this.txtBuscar.setText("MARANHAO");
            acaoBotaoPesquisar();
        } else {
            JOptionPane.showMessageDialog(this, "" + "\n Camada GUI:\n"
                    + "Sem Conectividade: Verifica \n a Conexao entre a aplicação e o Banco Hospedado "
    ...
    private void initComponents() {
        ...
        painelCabecalho.add(txtBuscar, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 20, 130, 30));
        ...
        painelCabecalho.add(btnPesquisar, new org.netbeans.lib.awtextra.AbsoluteConstraints(140, 20, 32, 32));
        painelCabecalho.add(progressBarraPesquisa, new org.netbeans.lib.awtextra.AbsoluteConstraints(230, 30, 60, -1));

        jLabel3.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagens/barra/nuvem/nuvemConectada.png"))); // NOI18N
        painelCabecalho.add(jLabel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(180, 20, 60, 40));
        ...
        layout.setVerticalGroup(
            layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addGroup(layout.createSequentialGroup()
                .addComponent(painelCabecalho, javax.swing.GroupLayout.PREFERRED_SIZE, 72, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void tabelaMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tabelaMouseClicked
        ...
        txtidEstadoTutor.setText(tabela.getValueAt(linha, 0).toString());
        txtEstadoTutor.setText(tabela.getValueAt(linha, 1).toString());
